...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Persona matteo = new Persona(4,"M",ANSI_RED);
        Persona matteoNicolo = new Persona(5,"M/N",ANSI_GREEN);
        Persona gigi = new Persona(4,"G",ANSI_YELLOW);
        Persona enrico = new Persona(5,"E",ANSI_BLUE);
        Persona lally = new Persona(4,"F",ANSI_PURPLE);
        Persona pietro = new Persona(4,"D",ANSI_CYAN);
        Persona pandi = new Persona(4,"P",ANSI_WHITE);
        Persona omar = new Persona(3,"O",idk);
